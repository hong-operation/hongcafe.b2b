...
import { Clock, Users, Shield, CheckCircle, TrendingUp } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow flex flex-col h-full">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <a href="#" className="text-primary font-semibold text-sm md:text-base hover:underline transition-colors">
                  상담 시작하기
                </a>
              </div>
            </div>
            ...
            <div className="bg-background rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-1 flex flex-col h-full">
              ...
              <div className="p-6 md:p-7 flex flex-col flex-grow">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Link href="/partnership" className="text-primary font-semibold text-sm hover:underline transition-colors">
                    문의하기
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-background rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all hover:-translate-y-1 flex flex-col h-full">
              ...
              <div className="p-6 md:p-7 flex flex-col flex-grow">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Link href="/unitaro" className="text-primary font-semibold text-sm hover:underline transition-colors">
                    문의하기
                  </Link>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white rounded-lg p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <Link href="/partnership">
                <a className="text-primary font-semibold text-sm md:text-base hover:underline transition-colors">
                  자세히 보기
                </a>
              </Link>
            </div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container text-center">
          ...
          <a href="#" className="text-primary font-semibold text-base md:text-lg hover:underline transition-colors">
            홍카페 바로가기
          </a>
        </div>
      </section>
